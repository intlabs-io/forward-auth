...
func (stage *evaluationStage) swapWith(other *evaluationStage) {
...
func (stage *evaluationStage) setToNonStage(other evaluationStage) {
...
func (stage *evaluationStage) isShortCircuitable() bool {
