...
type Service interface {
	...
	ChangePassword(sessionID, tid, uid, hash string) (userJSON string, err error)
	...
	ResetPassword(sessionID, tid, uid, hash, token string) (userJSON string, err error)
	...
	SendPasswordReset(tid, email, returnUrl, jwt string) (err error)
