...
$ swag init
```
4.Download [httptreemux-swagger](https://github.com/swaggo/httptreemux-swagger) by using:
```sh
...
```go
import "github.com/swaggo/httptreemux-swagger" // httptreemux-swagger middleware
```
...
import (
	...
	_ "github.com/swaggo/httptreemux-swagger/example/docs" // docs is generated by Swag CLI, you have to import it.
)
